            ...
            <div class="row g-4">
                <div class="col-md-4">
                    <div class="card h-100">
                        <?php if (session()->get('admin')): ?>
                            <!-- Administraciñon de buses -->
                            <img src="<?= base_url('/images/bus.png')?>" class="card-img-top" style="height: 150px;">
                            <div class="card-body">
                                <h3 class="card-title">Administración de buses</h3>
                                <p class="card-text">
                                    Gestión de Vehículos de Servicio Público
                                </p>
                                <a href="<?= site_url('/admin/buses'); ?>" class="btn btn-primary">Ver buses</a>
                            </div>
                            <?php else: ?>
                                <!-- Reserva de Billetes -->
